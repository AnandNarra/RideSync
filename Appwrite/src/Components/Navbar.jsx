        ...
        <div className="flex h-16 items-center justify-between">
...

          {
            user ? (<div className="flex items-center gap-3">
              ...
              <button className="px-5 py-2 text-sm font-semibold rounded-full bg-blue-600 text-white hover:bg-blue-700 shadow-md hover:shadow-lg transition-all" onClick={handleLogout} disabled={isLoading} >
                Logout
              </button>
